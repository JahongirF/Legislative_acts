...
public class Tamojenniy_kodeks_kir {
    ...
    public static List<Acts_Subtitle> getActs_Subtitle() {
        ...
        acts_subtitles.add(new Acts_Subtitle("II бўлим. Божхона режимлари"));
        acts_subtitles.add(new Acts_Subtitle("III бўлим. Транспорт воситаларига ва товарларнинг айрим тоифаларига нисбатан божхона режимларининг қўлланилиши"));
        acts_subtitles.add(new Acts_Subtitle("IV бўлим. Божхона назорати"));
        acts_subtitles.add(new Acts_Subtitle("V бўлим. Божхона ишида валюта назорати ва ташқи савдо операцияларининг мониторинги"));
        acts_subtitles.add(new Acts_Subtitle("VI бўлим. Божхона расмийлаштируви"));
        acts_subtitles.add(new Acts_Subtitle("VII бўлим. Декларант, божхона брокери ва божхона расмийлаштируви бўйича мутахассис"));
        acts_subtitles.add(new Acts_Subtitle("VIII бўлим. Божхона тўловлари"));
        acts_subtitles.add(new Acts_Subtitle("IX бўлим. Божхона статистикаси. Божхона ишида ахборот-коммуникация технологиялари. Интеллектуал мулк объектларига бўлган ҳуқуқларни ҳимоя қилиш"));
        acts_subtitles.add(new Acts_Subtitle("X бўлим. Чет эллик шахсларнинг айрим тоифалари учун божхона имтиёзлари"));
